...
let menuBotones = `
        ...
        <button type="button" class="btn btn-secondary"><img width="35" src="https://cdn.icon-icons.com/icons2/624/PNG/512/RGB_Circle_1-80_icon-icons.com_57282.png"><input id="color" type="color" value="#ffffff" style="opacity:0;position:absolute;left: 0;top:0;width: 100%;height: 100%;"></button></div>
